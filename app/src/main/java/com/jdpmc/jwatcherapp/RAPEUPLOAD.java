...
import com.jdpmc.jwatcherapp.activities.UploadMediaActivity;
...
public class RAPEUPLOAD extends AppCompatActivity implements View.OnClickListener {
    @BindView(R.id.rapeimage_headers)
    AppCompatImageView image_header;

    @BindView(R.id.rapeselectImages)
    AppCompatImageView selectImage;

    @BindView(R.id.rapecomments)
    TextInputLayout comment;

    @BindView(R.id.rapeinput_comments)
    TextInputEditText input_comment;

    @BindView(R.id.rapebutton_upload)
    MaterialButton button_upload;

    @BindView(R.id.rapeprogress)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_r_a_p_e_u_p_l_o_a_d);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.rapebutton_upload:
                ...
                break;
            case R.id.rapeselectImages:
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    if ((ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)) {
                        ActivityCompat.requestPermissions(RAPEUPLOAD.this, new String[] { Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE }, 0);
                    } else {
                        launchImagePicker();
                    }
                } else {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == 0) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED
                ...
                Toast.makeText(RAPEUPLOAD.this, "Permission denied, the permissions are very important for the apps usage", Toast.LENGTH_SHORT).show();
            }
        }
    }
                ...
                .itemsCallback((dialog, view, which, text) -> {
                    switch (which) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://tocnetng.com.ng/Youtube%20Script/Youtube_Demo-master/index.php"));
    ...
    private void submitDetails(String mcomment){
        ...
        Call<Void> call = userService.uploadRape(comment, body, reporter, latitude, longitude, type);
        call.enqueue(new Callback<Void>() {
            ...
            public void onResponse(@NonNull Call<Void> call, @NonNull Response<Void> response) {
                if (response.isSuccessful()) {
                    ...
                    emptyInputEditText();
                    Toast.makeText(RAPEUPLOAD.this, "Rape Alert Reported successfully", Toast.LENGTH_SHORT).show();
                } else {
                    progress.setVisibility(View.GONE);
                    Toast.makeText(RAPEUPLOAD.this, "error Reporting Covid19...", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<Void> call, @NonNull Throwable t) {
                progress.setVisibility(View.GONE);
                Toast.makeText(RAPEUPLOAD.this, "Error Reporting See something..." + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    /**
