...
public class healthissues extends AppCompatActivity  implements ComplaintAdapter.ItemClickListener{
    ...
    private void prepareComplaint() {
        ...
        Complaint a = new Complaint(1, covers[0], "Ambulance Services");
        complaintList.add(a);

        a = new Complaint(2, covers[1], "Health Facilities");
        complaintList.add(a);

        a = new Complaint(3, covers[2], "Open Corps");
        complaintList.add(a);

        a = new Complaint(4, covers[3], "Fake Drugs");
        complaintList.add(a);

        a = new Complaint(5, covers[4], "NAFDAC");
        complaintList.add(a);

        a = new Complaint(6, covers[5], "NDLEA");
        complaintList.add(a);
    ...
    public void onItemClickListener(int itemId) {
        if (itemId == 1) {
            ...
            Intent intent = new Intent(this, Healthfacilities.class);
            startActivity(intent);
        } else if (itemId == 3) {
            Intent intent = new Intent(this, Opencorpse.class);
            startActivity(intent);
        } else if (itemId == 4) {
            Intent intent = new Intent(this, Fakedrugs.class);
            startActivity(intent);
        } else if (itemId == 5) {
            Intent intent = new Intent(this, nafdac.class);
            startActivity(intent);
        } else if (itemId == 6) {
            Intent intent = new Intent(this, ndlea.class);
            startActivity(intent);
        }
    ...
    private void bindCustomTabsService() {
        ...
        connection = new CustomTabsServiceConnection() {
            ...
            public void onCustomTabsServiceConnected(ComponentName name, CustomTabsClient client) {
                healthissues.this.client = client;
