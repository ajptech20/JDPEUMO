...
public class newsupdate extends AppCompatActivity  implements ComplaintAdapter.ItemClickListener{
    ...
    private void prepareComplaint() {
        ...
        Complaint a = new Complaint(1, covers[0], "Radio Station");
        complaintList.add(a);

        a = new Complaint(2, covers[1], "TV Station");
        complaintList.add(a);
    ...
    public void onItemClickListener(int itemId) {
        if (itemId == 1) {
            Intent intent = new Intent(this, radiostation.class);
            startActivity(intent);
        } else if (itemId == 2) {
            Intent intent = new Intent(this, tvstation.class);
            startActivity(intent);
        }
    }
