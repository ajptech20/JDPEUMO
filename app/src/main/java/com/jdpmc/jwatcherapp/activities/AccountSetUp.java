...
public class AccountSetUp extends AppCompatActivity {
    ...
    public static Intent createIntent(Activity activity, Uri uri) {
        Intent intent = new Intent(activity, AccountSetUp.class);
        intent.setData(uri);
        return intent;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        select_image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Dexter.withActivity(AccountSetUp.this)
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(AccountSetUp.this, "Click the Save button to Continue:", Toast.LENGTH_SHORT).show();
        ...
        call.enqueue(new Callback<Void>() {
            ...
            public void onResponse(@NonNull Call<Void> call, @NonNull Response<Void> response) {
                if (response.isSuccessful()) {
                    ...
                    emptyInputEditText();
                    Intent intent = new Intent(AccountSetUp.this, SplashActivity.class);
                    startActivity(intent);
                    finish();
                    FancyToast.makeText(getApplicationContext(), "Account Profile Created successfully", FancyToast.LENGTH_LONG, FancyToast.SUCCESS, false).show();
                } else {
                    progress.setVisibility(View.GONE);
                    FancyToast.makeText(getApplicationContext(), "Error Creating Profile.....", FancyToast.LENGTH_LONG, FancyToast.ERROR, false).show();
                }
            }
