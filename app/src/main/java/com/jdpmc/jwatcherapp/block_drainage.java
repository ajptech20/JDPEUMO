...
public class block_drainage extends AppCompatActivity implements View.OnClickListener {
    @BindView(R.id.image_headered)
    AppCompatImageView image_header;

    @BindView(R.id.selectImaged)
    AppCompatImageView selectImage;

    @BindView(R.id.commented)
    TextInputLayout comment;

    @BindView(R.id.input_commented)
    TextInputEditText input_comment;

    @BindView(R.id.button_uploading)
    MaterialButton button_upload;

    @BindView(R.id.progressions)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_block_drainage);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button_uploading:
                ...
                break;
            case R.id.selectImaged:
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    if ((ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)) {
                        ActivityCompat.requestPermissions(block_drainage.this, new String[] { Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE }, 0);
                    } else {
                        launchImagePicker();
                    }
                } else {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == 0) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED
                ...
                Toast.makeText(block_drainage.this, "Permission denied, the permissions are very important for the apps usage", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void submitDetails(String mcomment){
        ...
        String mtype = "Collaps Beaulding";
        ...
        Call<Void> call = userService.uploadCommen(comment, body, reporter, latitude, longitude, type);
        call.enqueue(new Callback<Void>() {
            ...
            public void onResponse(@NonNull Call<Void> call, @NonNull Response<Void> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    emptyInputEditText();
                    Toast.makeText(block_drainage.this, "Building Collapse Alert Reported successfully", Toast.LENGTH_SHORT).show();
                    mp8.start();
                } else {
                    progress.setVisibility(View.GONE);
                    Toast.makeText(block_drainage.this, "error Reporting Building collapse...", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<Void> call, @NonNull Throwable t) {
                progress.setVisibility(View.GONE);
                Toast.makeText(block_drainage.this, "Error Reporting Discrimination..." + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
