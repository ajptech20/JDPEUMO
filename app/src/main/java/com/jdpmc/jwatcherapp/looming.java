...
public class looming extends AppCompatActivity implements View.OnClickListener {
    @BindView(R.id.image_headers)
    AppCompatImageView image_header;

    @BindView(R.id.selectImages)
    ...
    @BindView(R.id.button_uploads)
    MaterialButton button_upload;

    @BindView(R.id.progression)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_looming);
        ...
        setTitle("Looming Building Collapse");
            ...
            case R.id.selectImages:
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    if ((ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)) {
                        ActivityCompat.requestPermissions(looming.this, new String[] { Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE }, 0);
                    } else {
                        launchImagePicker();
                    }
                } else {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == 0) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED
                ...
                Toast.makeText(looming.this, "Permission denied, the permissions are very important for the apps usage", Toast.LENGTH_SHORT).show();
            }
        }
    }
        ...
        call.enqueue(new Callback<Void>() {
            ...
            public void onResponse(@NonNull Call<Void> call, @NonNull Response<Void> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    emptyInputEditText();
                    Toast.makeText(looming.this, "Building Collapse Alert Reported successfully", Toast.LENGTH_SHORT).show();
                    mp8.start();
                } else {
                    progress.setVisibility(View.GONE);
                    Toast.makeText(looming.this, "error Reporting Building collapse...", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<Void> call, @NonNull Throwable t) {
                progress.setVisibility(View.GONE);
                Toast.makeText(looming.this, "Error Reporting Discrimination..." + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
