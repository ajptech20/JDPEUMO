...
import com.a2tocsolutions.nispsasapp.adapter.ImgPostAdapter;
import com.a2tocsolutions.nispsasapp.database.ImgPost;
import com.a2tocsolutions.nispsasapp.utils.Config;
...
public class ImagePostsActivity extends AppCompatActivity implements RecyclerView.OnScrollChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(ImagePostsActivity.this)
                .load(user_image)
                .into(imageView);
        ...
        adapter = new ImgPostAdapter(listSuperHeroes, this);
        ...
        gbv_plain_form_rep.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ImagePostsActivity.this, Gbv_form_Activity.class);
        ...
        hot_zone_rep.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ImagePostsActivity.this, hot_picture_uploader.class);
        ...
        view_live_videos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ImagePostsActivity.this, LiveVideoActivity.class);
                //Intent intent = new Intent(getApplicationContext(), shortvideo_uploader.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_in_right);
                finish();
        ...
        short_video_post.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ImagePostsActivity.this, ShortVideoActivity.class);
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Config.DATA_URL + String.valueOf(requestCount),
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ImagePostsActivity.this, "No More Items Available", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void parseData(JSONArray array) {
        for (int i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                superHero.setStatus(json.getString(Config.TAG_STATUS));
                superHero.setRepType(json.getString(Config.TAG_REPTYP));
                superHero.setArea(json.getString(Config.TAG_AREA));
                superHero.setLikes(json.getString(Config.TAG_LIKES));
                superHero.setComments(json.getString(Config.TAG_COMMENTS));
                superHero.setPreview(json.getString(Config.TAG_PREVIEW));
                superHero.setResUri(json.getString(Config.TAG_RSURI));
