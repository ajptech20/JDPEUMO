...
public class ImageCroperActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.image_croper_activity);
    ...
    public void startResultActivity(Uri uri) {
        ...
        startActivity(UserDataUpdate.createIntent(this, uri));
    }
...
//    }
    ...
    public Uri createSaveUri() {
        return createNewUri(ImageCroperActivity.this, mCompressFormat);
    }
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            switch (requestCode) {
                ...
                case REQUEST_SAVE_PICK_IMAGE:
                    mSourceUri = Utils.ensureUriPermission(ImageCroperActivity.this, result);
                    mCropView.load(mSourceUri)
                            .initialFrameRect(mFrameRect)
                            .useThumbnail(true)
                            .execute(mLoadCallback);
