...
public class Nested_scrool_test extends AppCompatActivity {
    ...
    private void getData() {
        ...
        RequestQueue queue = Volley.newRequestQueue(Nested_scrool_test.this);
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    ...
                    try {
                        ...
                        Toast.makeText(Nested_scrool_test.this, url , Toast.LENGTH_SHORT).show();

                        // on below line we are adding our array list to our adapter class.
                        courseRVAdapter = new CourseRVAdapter(Nested_scrool_test.this, courseArrayList);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Nested_scrool_test.this, "Fail to get the data..", Toast.LENGTH_SHORT).show();
            }
        });
