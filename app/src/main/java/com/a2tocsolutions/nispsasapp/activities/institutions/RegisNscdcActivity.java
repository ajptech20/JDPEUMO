...
import static com.a2tocsolutions.nispsasapp.utils.Constants.EAAP;

public class RegisNscdcActivity extends AppCompatActivity  implements VerifyAdapter.ItemClickListener{
    ...
    private void prepareVerify() {
        ...
        Verify a = new Verify(1, covers[0], "Motor Park Registration");
        verifyList.add(a);

        a = new Verify(2, covers[1], "Electronic Address Auth. Program");
        verifyList.add(a);
    ...
    public void onItemClickListener(int itemId) {
        if (itemId == 1) {
            Intent intent = new Intent(this, MotorReg.class);
            ...
            customTabsIntent.launchUrl(this, Uri.parse(EAAP));
    ...
    private void bindCustomTabsService() {
        ...
        connection = new CustomTabsServiceConnection() {
            ...
            public void onCustomTabsServiceConnected(ComponentName name, CustomTabsClient client) {
                RegisNscdcActivity.this.client = client;
