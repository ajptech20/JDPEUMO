...
public class EduActivity extends AppCompatActivity  implements VerifyAdapter.ItemClickListener{
    ...
    private void prepareVerify() {
        ...
        Verify a = new Verify(1, covers[0], "Registrations");
        verifyList.add(a);

       a = new Verify(2, covers[1], "CIRP");
        verifyList.add(a);
    ...
    public void onItemClickListener(int itemId) {
        if (itemId == 1) {
            Intent intent = new Intent(this, EduregActivity.class);
            startActivity(intent);
        } else if (itemId == 2) {
        Intent intent = new Intent(this, EdureportActivity.class);
           startActivity(intent);
        }
    ...
    private void bindCustomTabsService() {
        ...
        connection = new CustomTabsServiceConnection() {
            ...
            public void onCustomTabsServiceConnected(ComponentName name, CustomTabsClient client) {
                EduActivity.this.client = client;
