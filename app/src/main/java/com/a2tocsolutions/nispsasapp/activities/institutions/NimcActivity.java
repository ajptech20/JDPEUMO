...
import com.a2tocsolutions.nispsasapp.activities.VerifyNational;
...
public class NimcActivity extends AppCompatActivity  implements VerifyAdapter.ItemClickListener{
    ...
    private void bindCustomTabsService() {
        ...
        connection = new CustomTabsServiceConnection() {
            ...
            public void onCustomTabsServiceConnected(ComponentName name, CustomTabsClient client) {
                NimcActivity.this.client = client;
