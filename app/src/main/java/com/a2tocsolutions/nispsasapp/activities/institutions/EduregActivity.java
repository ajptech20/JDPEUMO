...
import static com.a2tocsolutions.nispsasapp.utils.Constants.EDUCATE;

public class EduregActivity extends AppCompatActivity  implements VerifyAdapter.ItemClickListener{
    ...
    private void prepareVerify() {
        ...
        Verify a = new Verify(1, covers[0], "School Registration");
        verifyList.add(a);

        a = new Verify(2, covers[1], "Student Registration");
        verifyList.add(a);
    ...
    public void onItemClickListener(int itemId) {
        if (itemId == 1) {
            Intent intent = new Intent(this, SchoolReg.class);
            ...
            customTabsIntent.launchUrl(this, Uri.parse(EDUCATE));
    ...
    private void bindCustomTabsService() {
        ...
        connection = new CustomTabsServiceConnection() {
            ...
            public void onCustomTabsServiceConnected(ComponentName name, CustomTabsClient client) {
                EduregActivity.this.client = client;
