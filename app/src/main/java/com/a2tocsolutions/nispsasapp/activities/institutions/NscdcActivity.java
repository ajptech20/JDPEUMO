...
public class NscdcActivity extends AppCompatActivity  implements VerifyAdapter.ItemClickListener{
    ...
    private void prepareVerify() {
        ...
        Verify a = new Verify(1, covers[0], "Identity Verification");
        verifyList.add(a);

        a = new Verify(2, covers[1], "Registration");
        verifyList.add(a);
    ...
    public void onItemClickListener(int itemId) {
        if (itemId == 1) {
            Intent intent = new Intent(this, VerifyNscdcActivity.class);
            startActivity(intent);
        } else if (itemId == 2) {
            Intent intent = new Intent(this, RegisNscdcActivity.class);
            startActivity(intent);
        }
    ...
    private void bindCustomTabsService() {
        ...
        connection = new CustomTabsServiceConnection() {
            ...
            public void onCustomTabsServiceConnected(ComponentName name, CustomTabsClient client) {
                NscdcActivity.this.client = client;
