...
public class VerifyExtinguisher extends AppCompatActivity implements View.OnClickListener {
    ...
    public Boolean verifyFields() {
        ...
        if (input_text.length() == 0) {
            ...
            fire_layout.setError(getString(R.string.error_fire));
                ...
                call.enqueue(new Callback<ExtinguisherResponse>() {
                    ...
                    public void onResponse(@NonNull Call<ExtinguisherResponse> call, @NonNull Response<ExtinguisherResponse> response) {
                       if (response.isSuccessful()) {
                           ...
                           progress.setVisibility(View.GONE);
                           Toast.makeText(VerifyExtinguisher.this, "error verifying extinguisher", Toast.LENGTH_SHORT).show();
                       }
                    }
                    ...
                    public void onFailure(@NonNull Call<ExtinguisherResponse> call, @NonNull Throwable t) {
                        progress.setVisibility(View.GONE);
                        Toast.makeText(VerifyExtinguisher.this, "I am not Connected to the Internet !", Toast.LENGTH_SHORT).show();
                    }
                });
            } catch (Exception e) {
                progress.setVisibility(View.GONE);
    ...
    private void showDialog(String text) {
        ...
        MaterialDialog dialog = new MaterialDialog.Builder(VerifyExtinguisher.this)
