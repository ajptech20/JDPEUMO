...
public class VerifyHospital extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Verify Hospital / Pharmacy");
        read_barcode.setOnClickListener(this);
        TextView note = (TextView) findViewById(R.id.algon_note);
        note.setText("Enter the ALGON Code of the Hospital to verify");
                ...
                call.enqueue(new Callback<ResponseTransporter>() {
                    ...
                    public void onResponse(@NonNull Call<ResponseTransporter> call, @NonNull Response<ResponseTransporter> response) {
                        if (response.isSuccessful()) {
                            ...
                            progress.setVisibility(View.GONE);
                            Toast.makeText(VerifyHospital.this, "Invalid ALGON Code !", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(@NonNull Call<ResponseTransporter> call, @NonNull Throwable t) {
                        progress.setVisibility(View.GONE);
                        Toast.makeText(VerifyHospital.this, "I am not Connected to the Internet !", Toast.LENGTH_SHORT).show();

                    }
                });
            } catch (Exception e) {
                progress.setVisibility(View.GONE);
                Toast.makeText(VerifyHospital.this, "Invalid ALGON Code Can't Try !", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void showDialog(String dresponse, String dname, String dimage) {
        ...
        MaterialDialog dialog = new MaterialDialog.Builder(VerifyHospital.this)
                .title(dname)
