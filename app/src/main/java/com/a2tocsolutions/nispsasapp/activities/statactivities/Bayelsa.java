...
public class Bayelsa extends AppCompatActivity  implements ComplaintAdapter.ItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Bayelsa State Complaints");
