...
import com.a2tocsolutions.nispsasapp.activities.institutions.ImmigrationActivity;
...
public class Imigration extends AppCompatActivity implements View.OnClickListener {

    @BindView(R.id.immiimage_header)
    AppCompatImageView image_header;

    @BindView(R.id.immiselectImage)
    AppCompatImageView selectImage;

    @BindView(R.id.immicomment)
    TextInputLayout comment;

    @BindView(R.id.immiinput_comment)
    TextInputEditText input_comment;

    @BindView(R.id.immibutton_upload)
    MaterialButton button_upload;

    @BindView(R.id.immiprogress)
    ...
    private static final String TAG = CovidActivity.class.getSimpleName();
    private String path;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_imigration);
        ...
        covidtyp = (Spinner) findViewById(R.id.immitype);
        covidtyp.setOnItemSelectedListener(new Imigration.ItemSelectedListener());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.immibutton_upload:
                ...
                break;
            case R.id.immiselectImage:
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    if ((ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)) {
                        ActivityCompat.requestPermissions(Imigration.this, new String[] { Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE }, 0);
                    } else {
                        launchImagePicker();
                    }
                } else {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == 0) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED
                ...
                Toast.makeText(Imigration.this, "Permission denied, the permissions are very important for the apps usage", Toast.LENGTH_SHORT).show();
            }
        }
    }
                ...
                .itemsCallback((dialog, view, which, text) -> {
                    switch (which) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://nispsas.com.ng/Videos/"));
    ...
    private void submitDetails(String mcomment){
        ...
        String mreportedto = covidtyp.getSelectedItem().toString();
        ...
        Call<Void> call = userService.uploadComment(comment, body, reporter, latitude, longitude, type , reportedto);
        call.enqueue(new Callback<Void>() {
            ...
            public void onResponse(@NonNull Call<Void> call, @NonNull Response<Void> response) {
                if (response.isSuccessful()) {
                    ...
                    emptyInputEditText();
                    Toast.makeText(Imigration.this, "Immigration Alert Reported successfully", Toast.LENGTH_SHORT).show();
                } else {
                    progress.setVisibility(View.GONE);
                    Toast.makeText(Imigration.this, "error Reporting Covid19...", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<Void> call, @NonNull Throwable t) {
                progress.setVisibility(View.GONE);
                Toast.makeText(Imigration.this, "Error Reporting Immigration Alert..." + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
