...
import com.a2tocsolutions.nispsasapp.activities.VerifyExtinguisher;
...
public class FfsActivity extends AppCompatActivity  implements VerifyAdapter.ItemClickListener{
    ...
    private void prepareVerify() {
        ...
        Verify a = new Verify(1, covers[0], "Verify Fire Extinguisher");
        verifyList.add(a);
    ...
    private void bindCustomTabsService() {
        ...
        connection = new CustomTabsServiceConnection() {
            ...
            public void onCustomTabsServiceConnected(ComponentName name, CustomTabsClient client) {
                FfsActivity.this.client = client;
