...
public class VerifyMedical extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String TAG = VerifyMedical.class.getSimpleName();
    private String path;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Verify Medical Personnel");
            ...
            case R.id.selectImage:
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if ((ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)) {
                        ActivityCompat.requestPermissions(VerifyMedical.this, new String[] { Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE }, 0);
                    } else {
                        captureImage();
                    }
                } else {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == 0) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED
                ...
                Toast.makeText(VerifyMedical.this, "Permission denied, the permissions are very important for the apps usage", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void submitDetails(MultipartBody.Part body){
        ...
        Call<ChildResponse> call = userService.nurseupload(body);
        call.enqueue(new Callback<ChildResponse>() {
            ...
            public void onResponse(@NonNull Call<ChildResponse> call, @NonNull Response<ChildResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    progress.setVisibility(View.GONE);
                    Toast.makeText(VerifyMedical.this, "Details not Found...", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<ChildResponse> call, @NonNull Throwable t) {
                progress.setVisibility(View.GONE);
                Toast.makeText(VerifyMedical.this, "Error uploading Image " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void showDialog(String text, String dimage) {
        ...
        MaterialDialog dialog = new MaterialDialog.Builder(VerifyMedical.this)
