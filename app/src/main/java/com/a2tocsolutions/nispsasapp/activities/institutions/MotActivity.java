...
import com.a2tocsolutions.nispsasapp.activities.VerifyTransporter;
...
public class MotActivity extends AppCompatActivity  implements VerifyAdapter.ItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Ministry Of Transaport");
    ...
    private void prepareVerify() {
        ...
        Verify a = new Verify(1, covers[0], "Verify Transporter ID");
        verifyList.add(a);
    ...
    private void bindCustomTabsService() {
        ...
        connection = new CustomTabsServiceConnection() {
            ...
            public void onCustomTabsServiceConnected(ComponentName name, CustomTabsClient client) {
                MotActivity.this.client = client;
