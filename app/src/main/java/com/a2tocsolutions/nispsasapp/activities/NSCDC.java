...
public class NSCDC extends AppCompatActivity implements View.OnClickListener {
    @BindView(R.id.nscdcimage_header)
    AppCompatImageView image_header;

    @BindView(R.id.nscdcselectImage)
    AppCompatImageView selectImage;

    @BindView(R.id.nscdccomment)
    TextInputLayout comment;

    @BindView(R.id.nscdcinput_comment)
    TextInputEditText input_comment;

    @BindView(R.id.nscdcbutton_upload)
    MaterialButton button_upload;

    @BindView(R.id.nscdcprogress)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_n_s_c_d_c);
        ...
        covidtyp = (Spinner) findViewById(R.id.nscdctype);
        covidtyp.setOnItemSelectedListener(new NSCDC.ItemSelectedListener());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.nscdcbutton_upload:
                ...
                break;
            case R.id.nscdcselectImage:
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    if ((ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)) {
                        ActivityCompat.requestPermissions(NSCDC.this, new String[] { Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE }, 0);
                    } else {
                        launchImagePicker();
                    }
                } else {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == 0) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED
                ...
                Toast.makeText(NSCDC.this, "Permission denied, the permissions are very important for the apps usage", Toast.LENGTH_SHORT).show();
            }
        }
    }
        ...
        call.enqueue(new Callback<Void>() {
            ...
            public void onResponse(@NonNull Call<Void> call, @NonNull Response<Void> response) {
                if (response.isSuccessful()) {
                    ...
                    emptyInputEditText();
                    Toast.makeText(NSCDC.this, "NSCDC Alert Reported successfully", Toast.LENGTH_SHORT).show();
                } else {
                    progress.setVisibility(View.GONE);
                    Toast.makeText(NSCDC.this, "error Reporting Covid19...", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<Void> call, @NonNull Throwable t) {
                progress.setVisibility(View.GONE);
                Toast.makeText(NSCDC.this, "Error Reporting NSCDC Alert..." + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
