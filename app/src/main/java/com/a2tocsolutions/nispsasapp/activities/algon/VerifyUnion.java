...
public class VerifyUnion extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Verify Union Members");
        read_barcode.setOnClickListener(this);
        submit.setOnClickListener(this);

        TextView note = (TextView) findViewById(R.id.algon_note);
        note.setText("Enter the ALGON Code of the Union Members to verify Him or Her");
                ...
                call.enqueue(new Callback<ResponseTransporter>() {
                    ...
                    public void onResponse(@NonNull Call<ResponseTransporter> call, @NonNull Response<ResponseTransporter> response) {
                        if (response.isSuccessful()) {
                            ...
                            progress.setVisibility(View.GONE);
                            Toast.makeText(VerifyUnion.this, "Invalid ALGON Code !", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(@NonNull Call<ResponseTransporter> call, @NonNull Throwable t) {
                        progress.setVisibility(View.GONE);
                        Toast.makeText(VerifyUnion.this, "I am not Connected to the Internet !", Toast.LENGTH_SHORT).show();

                    }
                });
            } catch (Exception e) {
                progress.setVisibility(View.GONE);
                Toast.makeText(VerifyUnion.this, "Invalid ALGON Code Can't Try !", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void showDialog(String dresponse, String dname, String dimage) {
        ...
        MaterialDialog dialog = new MaterialDialog.Builder(VerifyUnion.this)
                .title(dname)
