...
public class VerifyFamers extends AppCompatActivity implements View.OnClickListener {
                ...
                call.enqueue(new Callback<ResponseTransporter>() {
                    ...
                    public void onResponse(@NonNull Call<ResponseTransporter> call, @NonNull Response<ResponseTransporter> response) {
                        if (response.isSuccessful()) {
                            ...
                            progress.setVisibility(View.GONE);
                            Toast.makeText(VerifyFamers.this, "Invalid ALGON Code !", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(@NonNull Call<ResponseTransporter> call, @NonNull Throwable t) {
                        progress.setVisibility(View.GONE);
                        Toast.makeText(VerifyFamers.this, "I am not Connected to the Internet !", Toast.LENGTH_SHORT).show();

                    }
                });
            } catch (Exception e) {
                progress.setVisibility(View.GONE);
                Toast.makeText(VerifyFamers.this, "Invalid ALGON Code Can't Try !", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void showDialog(String dresponse, String dname, String dimage) {
        ...
        MaterialDialog dialog = new MaterialDialog.Builder(VerifyFamers.this)
                .title(dname)
