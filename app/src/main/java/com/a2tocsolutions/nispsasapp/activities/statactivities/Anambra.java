...
public class Anambra extends AppCompatActivity  implements ComplaintAdapter.ItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Anambra State Complaints");
