...
public class Nasarawa extends AppCompatActivity  implements ComplaintAdapter.ItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Nasarawa State Complaints");
