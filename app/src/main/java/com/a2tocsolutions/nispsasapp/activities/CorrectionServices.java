...
public class CorrectionServices extends AppCompatActivity implements View.OnClickListener {
    ...
    @BindView(R.id.corrimage_header)
    AppCompatImageView image_header;

    @BindView(R.id.corrselectImage)
    AppCompatImageView selectImage;

    @BindView(R.id.corrcomment)
    TextInputLayout comment;

    @BindView(R.id.corrinput_comment)
    TextInputEditText input_comment;

    @BindView(R.id.corrbutton_upload)
    MaterialButton button_upload;

    @BindView(R.id.corrprogress)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_correction_services);
        ...
        covidtyp = (Spinner) findViewById(R.id.corrtype);
        covidtyp.setOnItemSelectedListener(new CorrectionServices.ItemSelectedListener());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.corrbutton_upload:
                ...
                break;
            case R.id.corrselectImage:
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    if ((ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)) {
                        ActivityCompat.requestPermissions(CorrectionServices.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, 0);
                    } else {
                        launchImagePicker();
                    }
                } else {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == 0) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED
                ...
                Toast.makeText(CorrectionServices.this, "Permission denied, the permissions are very important for the apps usage", Toast.LENGTH_SHORT).show();
            }
        }
    }
        ...
        call.enqueue(new Callback<Void>() {
            ...
            public void onResponse(@NonNull Call<Void> call, @NonNull Response<Void> response) {
                if (response.isSuccessful()) {
                    ...
                    emptyInputEditText();
                    Toast.makeText(CorrectionServices.this, "Correction Alert Reported successfully", Toast.LENGTH_SHORT).show();
                } else {
                    progress.setVisibility(View.GONE);
                    Toast.makeText(CorrectionServices.this, "error Reporting Covid19...", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<Void> call, @NonNull Throwable t) {
                progress.setVisibility(View.GONE);
                Toast.makeText(CorrectionServices.this, "Error Reporting Correction Alert..." + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
