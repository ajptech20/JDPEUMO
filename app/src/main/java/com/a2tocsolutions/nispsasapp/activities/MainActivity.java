...
import com.a2tocsolutions.nispsasapp.DisasterPage;
import com.a2tocsolutions.nispsasapp.FireService;
import com.a2tocsolutions.nispsasapp.Fragments.AlertFrag;
import com.a2tocsolutions.nispsasapp.NEMA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seesay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent Intent = new Intent(getApplicationContext(), com.a2tocsolutions.nispsasapp.seesay.class);
                startActivity(Intent);
            }
        });
