...
public class Zamfara extends AppCompatActivity  implements ComplaintAdapter.ItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Zamfara State Complaints");
