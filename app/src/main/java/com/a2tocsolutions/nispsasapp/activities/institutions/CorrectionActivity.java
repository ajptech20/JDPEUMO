...
public class CorrectionActivity extends AppCompatActivity  implements VerifyAdapter.ItemClickListener{
    ...
    private void prepareVerify() {
        ...
        Verify a = new Verify(1, covers[0], "Verify Conviction Status");
        verifyList.add(a);
    ...
    public void onItemClickListener(int itemId) {
        if (itemId == 1) {
            Toast.makeText(getApplicationContext(), "No Data Available Yet", Toast.LENGTH_SHORT).show();
    ...
    private void bindCustomTabsService() {
        ...
        connection = new CustomTabsServiceConnection() {
            ...
            public void onCustomTabsServiceConnected(ComponentName name, CustomTabsClient client) {
                CorrectionActivity.this.client = client;
