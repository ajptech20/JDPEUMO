...
public class Katsina extends AppCompatActivity  implements ComplaintAdapter.ItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Katsina State Complaints");
